        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Rejected Document Detail <b id="hdr-version">Revision {{ $docversions[0]->doc_version }}</b></h3>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content" id="custom-content-above-tabContent">
                                <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                                    <form action="{{ url('/document/v2/updatedocversion') }}/{{ $docversions[0]->doc_version }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="doctitle" value="{{ $documents->document_title }}">
                                                        </div>  
                                                    </div>  
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="scope" value="{{ $wiDocData->scope }}">
                                                        </div>                                                    
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="establisheddate">Established Date</label>
                                                            <input type="date" name="establisheddate" class="form-control" value="{{ $docVersionData->established_date }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="ValidityDate" class="form-control" value="{{ $docVersionData->validity_date }}">
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">                                                                        
                                                                            @if(substr($wiDocData->implementation,0,1) === "Y")
                                                                                <input type="checkbox" id="imp1" name="imp1" checked>
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->implementation,1,1) === "Y")
                                                                                <input type="checkbox" id="imp2" name="imp2" checked>
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->implementation,2,1) === "Y")
                                                                                <input type="checkbox" id="imp3" name="imp3" checked>
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->reason,0,1) === "Y")
                                                                                <input type="checkbox" id="reason1" name="reason1" checked>  
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->reason,1,1) === "Y")
                                                                                <input type="checkbox" id="reason2" name="reason2" checked>  
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->reason,2,1) === "Y")
                                                                                <input type="checkbox" id="reason3" name="reason3" checked>  
                                                                            @else
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            @if(substr($wiDocData->reason,3,1) === "Y")
                                                                                <input type="checkbox" id="reason4" name="reason4" checked>  
                                                                            @else
