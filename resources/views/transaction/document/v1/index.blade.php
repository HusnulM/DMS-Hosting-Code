...
@section('title', 'Create Corporate Procedure Document')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('/document/v1/save') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create Corporate Procedure Document</h3>
